            ...
            <div className="main-wrapper">
                <div className="account-content">
                    <div className="container">
                        <div><div><p align="middle"><h1 classname="xyx"> Health Monitoring System</h1></p></div></div>

                        <div className="account-logo">
                            <img src={logo} width="100" alt="Health Monitoring System Logo" />
                        </div>
                        <div>
                            <p align="center">গুরুত্বপূর্ণ লিংকসমূহ:</p>
                            <marquee>
                                <a href="https://www.worldometers.info/coronavirus/" target="_blank"> করোনা ভাইরাস আপডেট </a> || <a href="http://mohfw.gov.bd/" target="_blank"> স্বাস্থ্য অধিদপ্তর, বাংলাদেশ </a> || <a href="http://www.bddrugs.com/search.php" target="_blank"> বিডি ড্রাগস </a> || <a href="https://www.kuet.ac.bd/index.php/office/medicalcenter" target="_blank"> কুয়েট মেডিক্যাল সেন্টার </a> ||
                            <a href="https://www.who.int/" target="_blank"> বিশ্ব স্বাস্থ্য সংস্থা </a>
