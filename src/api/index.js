...
export const fetchDoctorList = async (keyword) => {
    const userToken = localStorage.getItem('tokens');
    const res = await fetch(myConstClass.BASE_URL + '/getDoctorList.php', {
        method: "POST",
        header: {
            "Content-Type": "application/json",
            'Accept': 'application/json',
...
export const fetchUniqueDoctor = async (id) => {
    const userToken = localStorage.getItem('tokens');
    const res = await fetch(myConstClass.BASE_URL + '/getUniqueDoctor.php', {
        method: "POST",
        header: {
            "Content-Type": "application/json",
            'Accept': 'application/json',
