                            ...
                            isData.data.type === 'Patient'
                                ...
                                <ul>
                                    ...
                                    <li className={props.data.location.pathname === '/patient_message_list' ? 'active' : props.data.match.path === '/patient_message/:id' ? 'active' : ''}>
                                        <Link to={'/patient_message_list'}><i className="fa fa-inbox"></i> <span>Inbox</span></Link>
                                    </li>
                                    <li className={props.data.location.pathname === '/doctor_list' ? 'active' : props.data.match.path === '/doctor_details/:id' ? 'active' : ''}>
                                        <Link to={'/doctor_list'}><i className="fa fa-users"></i> <span>Doctor List</span></Link>
                                    </li>
                                </ul>
                                :
                                null
                            ...
                            isData.data.type === 'Doctor'
                                ...
                                <ul>
                                    <li className={props.data.location.pathname === '/doctor_message_list' ? 'active' : props.data.match.path === '/doctor_message/:id' ? 'active' : ''}>
                                        <Link to={'/doctor_message_list'}><i className="fa fa-inbox"></i> <span>Inbox</span></Link>
                                    </li>
